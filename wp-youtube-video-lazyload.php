<?php
/**
 * Plugin Name:       Best Youtube Video LazyLoad
 * Plugin URI:        https://wordpress.org/plugins/best-youtube-video-lazyload
...
function wp_youtube_video_lazyload_shortcode($atts){
    ...
    return '<div class="yt-lazyload" data-id="'.esc_attr($atts['id']).'" data-thumb="'.esc_url($thumb).'" data-logo="2"></div>';
}
